...
> Do all work in the monorepo: **`~/Developer/bwa-fx-ecosystem/BWA-BandShape/`**
...
```bash
git subtree push --prefix=BWA-BandShape git@github.com:vmcguire/BWA-BandShape.git main
```

Then cut a GitHub Release in this mirror and attach the notarized `BWA-BandShape.vst3`.
