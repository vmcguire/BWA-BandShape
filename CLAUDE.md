# BWA-BandShape — read before doing anything

> ✅ **This is the CANONICAL home for BWA-BandShape.** All serious DSP, IP, and
> process for this plugin live **here**, in `~/Developer/BWA-BandShape/`. Author here — always.
>
...
> changes. This file deliberately holds only what is specific to BWA-BandShape; every
...
4. **`docs/MARKET-PAIN-AND-ATTACKS.md`** — the row for **BWA-BandShape**; internalize the pain + attack before any DSP.
...
Then cut a GitHub Release here (`vmcguire/BWA-BandShape`) and attach the notarized `BWA-BandShape.vst3`.
